...
from keras import regularizers #add regularization to the weights
from keras import backend as K #for building new regularizers
#left out from keras.layers import Merge because error "cannot import name 'Merge'"
